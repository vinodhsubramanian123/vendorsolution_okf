...
class WorkflowState(TypedDict):
    ...
    portal_validation_errors: List[Dict[str, Any]]  # e.g. {"error": "Out of Stock", "type": "temporary"}
    is_valid_dynamic: bool
    
    # Knowledge Update & Learning
    learned_constraints: List[str]  # Temporary/Permanent rules learned from portal failures
